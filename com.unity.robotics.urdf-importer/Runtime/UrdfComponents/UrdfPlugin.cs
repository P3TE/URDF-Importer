...
namespace Unity.Robotics.UrdfImporter
{
    public class UrdfPlugin : MonoBehaviour
    {
        ...
        public static void Create(Transform parent, UrdfPluginDescription plugin = null)
        {
        ...
        public UrdfPluginDescription ExportPluginData()
        {
            ...
            try
            {
                ...
                return new UrdfPluginDescription(PluginText);
            }
